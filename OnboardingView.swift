...
struct OnboardingView: View {
    ...
    var slides: [OnboardingItem] = [
        OnboardingItem(
            ...
            description: "Discover Your World, Elevate Your Soul..",
            tag: 0
        ),
        OnboardingItem(
            imageName: "onboarding_slide_2",
            title: "The Choice is Yours. The World is Waiting.",
            description: "Discover with Confidence. Book with Clarity.",
            tag: 1),
        OnboardingItem(
            imageName: "onboarding_slide_3",
            title: "Fly to Your Future Memories.",
            description: "Your Dream Destination is Ready. Are You?",
            tag: 2),
    ]
